...
При помощи реакта созданы функциональные и классовые компоненты, настроено взаимодействие с сервером через REST API,
используются React хуки: useState и useEffect.
